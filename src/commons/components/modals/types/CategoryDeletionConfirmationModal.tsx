...
import { useDeleteCategoryMutation } from "../../../../store/category/api";
...
const CategoryDeletionConfirmationModal = () => {
  ...
  const [deleteCategoryById, { isLoading, error, isError, isSuccess }] =
            ...
            {isLoading ? (
              ...
              <>
                ...
                <RippleButton
                  ...
                  onClick={() => deleteCategoryById(props.categoryId)}
                >
                  Delete
                </RippleButton>
              </>
